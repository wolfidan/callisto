...
# Callist imports
from callisto.io_utils import read_motor_log
from callisto., paraboloid_2d, gaussian_2d
from callisto.utils import convert_decimal_hour_timedelta, readfit, log_execution
from callisto.utils import get_fit_files, average_around_time
from callisto.config import load_config
###########################################################################

# Get callisto config
callisto_config = load_config()
aziref    = callisto_config["Control"]["Tracker"]["azi_ref"]
eleref    = callisto_config["Control"]["Tracker"]["ele_ref"]
