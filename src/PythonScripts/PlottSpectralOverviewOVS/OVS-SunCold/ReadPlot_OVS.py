...
f = open(path+'OVS_SWISS-SCAN_Freienbach_20230705_113655_cold.prn', 'r')
Dcold = np.genfromtxt(f, delimiter=';',skip_header=1)
f.close()

f = open(path+'OVS_SWISS-SCAN_Freienbach_20230705_113424_sun.prn', 'r')
...
plt.plot(freq,Ihot,'-',color="red",label='Sun') #o,+,
...
plt.title('System response Sun - Sky')
